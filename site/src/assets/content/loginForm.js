export const loginContent = {
  french: {
    inputs: [
      ...
      {for: 'password', type: 'password', label: 'Mot de Passe'},
      {for: 'password_confirm', type: 'password', label: 'Confirmation du Mot de Passe'},
    ],
...
export const signUpContent = {
  french: {
    inputs: [
      ...
      {for: 'location', type: '', label: 'Pays', placeHolder: 'exp: Cameroun'},
    ],
